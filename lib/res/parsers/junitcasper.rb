    ...
    class Junitcasper
      ...
      def test_case(suite)
        ...
        testcases = suite.nodes.collect do |node|
          next unless node.value == 'testcase'
          testcase = {}
